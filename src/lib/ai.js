...
const analyzeText = async (inputText, categories) => {
   try {
      ...
      const prompt = `
         ...
         ## Output ONLY JSON. No explanations, no text, just JSON. If the input text is not suitable for financial statement extraction or or if the amount is equal to 0, output 'wrong'.
         ...
      `;
